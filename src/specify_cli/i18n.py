...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "top_level_items_detail": "{count} top-level items",
        ...
        "replacing_prompts_with_chinese": "Replacing prompts with Chinese versions",
        "chinese_prompts_not_found": "Chinese prompts not found",
        "replaced_prompt": "Replaced prompt",
        "replaced_prompts_count": "Replaced {count} prompts with Chinese versions",
        "prompts_replace_error": "Error replacing prompts",
    ...
    "top_level_items_detail": "{count} 个顶层项目",
        ...
        "replacing_prompts_with_chinese": "正在用中文版本替换提示",
        "chinese_prompts_not_found": "未找到中文提示",
        "replaced_prompt": "已替换提示",
        "replaced_prompts_count": "已用中文版本替换 {count} 个提示",
        "prompts_replace_error": "替换提示出错",
